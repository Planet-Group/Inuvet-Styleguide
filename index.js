...
(function () {
  ...
  var UI = {
    de: {
      ...
      cardPrintTitle: 'Print & PDF',
      cardPrintBody: 'Grundlage für druckfähige PDFs im Inuvet-Design — Reports, Preislisten, Kataloge, Datenblätter. Definiert Formate, Seitenraster, Logo-Position, Schriftgrößen in Punkt und die CMYK-Farbzuordnung; dazu die Pipeline, die HTML zu druckfertigem PDF verarbeitet und das Ergebnis nachmisst.',
      ctaPrint: 'Zum Print-Guide',
    ...
    en: {
      ...
      cardPrintTitle: 'Print & PDF',
      cardPrintBody: 'The basis for print-ready PDFs in Inuvet design — reports, price lists, catalogues, data sheets. Defines formats, page grid, logo position, type sizes in points and the CMYK colour mapping, plus the pipeline that turns HTML into print-ready PDF and measures the result.',
      ctaPrint: 'Open print guide',
