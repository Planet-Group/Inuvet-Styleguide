...
(function () {
  ...
  var UI = {
    de: {
      ...
      cardFreigabeBody: 'Vet-Portal zum Ausstellen einer Freigabe ohne vorherige Anfrage: Empfänger und Consent, Produkt- und Mengenwahl, E-Mail-Vorschau. Einstieg ins Freigabe-Menü (Offene Anfragen, Freigegeben, Nicht freigegeben, Programm) — Menu A wie im Standard-Shop.',
    ...
    en: {
      ...
      cardFreigabeBody: 'Vet portal for issuing an approval without a prior request: recipient and consent, product and quantity selection, email preview. Entry to the approval menu (open requests, approved, declined, how it works) — Menu A like the standard shop.',
