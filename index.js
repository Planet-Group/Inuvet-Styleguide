...
(function () {
  ...
  var UI = {
    de: {
      ...
      cardDesignBody: 'Tokens, Atome, Moleküle und Organismen — die verbindliche Referenz für Typografie, Farben, Spacing und alle UI-Bausteine. Hier prüft ihr, welche Klasse schon existiert, bevor etwas Neues gebaut wird; der Guide spiegelt 1:1 die Styles aus inuvet.css.',
      ...
      cardShopBody: 'Shopify-Startseite mit Hero, Produktteasern und den Shop-Pop-ups (u. a. Praxis-Opt-in, Rezept). Referenz für Announcement, Navigation Menu A und die globale Warenkorb-/Suche-Chrome — ohne Tierarzt-Empfehlungs-Sonderlogik.',
      cardPdpTitle: 'Produktdetailseite',
      cardPdpBody: 'Produktdetailseite mit Sticky-Galerie, Kaufblock, Naturalrabatt-Widget, Social Proof und Sticky ATC. Zeigt das Produktmodell (Familie vs. Einzelprodukt, Varianten) so, wie es ins Theme übernommen werden soll.',
      cardCollectionTitle: 'Collection',
      cardCollectionBody: 'Produktübersicht mit optionaler Filter-Sidebar, Sortierung und gemischten Sonderkacheln (Featured, Cover, Lottie). Spaltenlayout und Empty-State entsprechen der Collection-Spec (E.3) fürs Shopify-Theme.',
    ...
    en: {
      ...
      secStyleguide: 'Styleguide',
      cardDesignTitle: 'Design system',
      cardDesignBody: 'Tokens, atoms, molecules and organisms — the binding reference for typography, colour, spacing and all UI building blocks. Use it to check which class already exists before building anything new; the guide mirrors inuvet.css 1:1.',
      ...
      cardShopBody: 'Shopify homepage with hero, product teasers and shop pop-ups (e.g. practice opt-in, prescription). Reference for announcement bar, Menu A navigation and global cart/search chrome — without vet-recommendation special logic.',
      cardPdpTitle: 'Product detail page',
      cardPdpBody: 'Product detail page with sticky gallery, buy block, natural-discount widget, social proof and sticky ATC. Shows the product model (family vs. single product, variants) as it should land in the theme.',
      cardCollectionTitle: 'Collection',
      cardCollectionBody: 'Product listing with optional filter sidebar, sorting and mixed featured tiles (cover, Lottie, etc.). Column layout and empty state match the collection spec (E.3) for the Shopify theme.',
      secSections: 'Sections',
