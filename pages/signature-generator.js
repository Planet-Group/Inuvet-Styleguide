(function () {
  ...
  var LOCALES = {
    ...
    'ch-it': {
      lang: 'it',
      company: 'Inuvet (parte di PLNT Group IT S.r.l)',
    ...
    'be-fr': {
      lang: 'fr',
      company: 'Inuvet / PLNT Group BE B.V.',
    ...
    nl: {
      lang: 'nl',
      company: 'Inuvet – PLNT Group NL B.V.',
    ...
    es: {
      lang: 'es',
      company: 'Inuvet GmbH (Forma parte de PLNT Group)',
