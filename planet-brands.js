    ...
    const apply = () => {
      try {
        ...
        if (w && h) {
          ...
          /* V3/V4 Cover: height 100%. V3 --media-ratio und V1/V2: Höhe aus JSON-Ratio. */
          if (player.closest('.section-type.--v3.--media-ratio') ||
              (!player.closest('.section-type.--v3') && !player.closest('.section-type.--v4'))) {
